  ...
  (defun my-modus-themes-custom-faces (&rest _)
    (modus-themes-with-colors
      (custom-set-faces
       ...
       `(combobulate-query-highlight-fiery-flames-face ((,c :background ,bg-red-intense :foreground ,fg-main)))
       `(combobulate-query-highlight-gleaming-gold-face ((,c :background ,bg-yellow-intense :foreground ,fg-main)))
       `(combobulate-query-highlight-majestic-mercury-face ((,c :background ,bg-cyan-intense :foreground ,fg-main)))
       `(combobulate-query-highlight-mysterious-mauve-face ((,c :background ,bg-magenta-intense :foreground ,fg-main)))
       `(combobulate-query-highlight-radiant-rind-face ((,c :background ,bg-red-subtle :foreground ,fg-main)))
       `(combobulate-query-highlight-regal-ripples-face ((,c :background ,bg-blue-intense :foreground ,fg-main)))
       `(combobulate-query-highlight-serene-shade-face ((,c :background ,bg-green-subtle :foreground ,fg-main)))
       `(combobulate-query-highlight-silver-shadows-face ((,c :background ,bg-active :foreground ,fg-main)))
       `(combobulate-query-highlight-vibrant-veggie-face ((,c :background ,bg-green-intense :foreground ,fg-main)))
       `(combobulate-query-highlight-underline-blue-face ((,c :underline ,underline-link)))
       `(combobulate-query-highlight-underline-red-face ((,c :underline ,underline-link-visited)))
       ...
       `(combobulate-refactor-disabled-field-face ((,c :background ,bg-blue-subtle :foreground ,fg-main :extend nil)))
       ...
       `(combobulate-refactor-label-face ((,c :background ,bg-search-replace :foreground ,fg-main)))
